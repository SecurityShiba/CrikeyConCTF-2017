...
shuffleit = string.maketrans(shuffled_alphabet,alphabet)

handler = open("encrypted_file",'rb')
handler2 = open("original_file",'wb')
contents = handler.read()
handler2.write(string.translate(xor_c(contents),shuffleit))


# http://stackoverflow.com/questions/16030637/xor-encryption-on-binary-file-in-python	
